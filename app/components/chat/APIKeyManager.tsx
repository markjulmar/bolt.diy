...
interface APIKeyManagerProps {
  ...
  setManagedIdentityOptions: (options: ManagedIdentityOptions) => void;
}
...
export function getManagedIdentityOptionsFromCookies() {
  ...
  let parsedManagedIdentity: ManagedIdentityOptions = { clientId: '', tenantId: '', clientSecret: '' };
...
export const APIKeyManager: React.FC<APIKeyManagerProps> = ({
  ...
  const showManagedIdentityInfo = provider.supportsManagedIdentity && !isEnvKeySet && !apiKey;

  return (
    <div className="flex flex-wrap items-center justify-between py-3 px-1">
      <div className="flex items-center gap-2 flex-1">
        <div className="flex items-center gap-2">
          {showManagedIdentityInfo ? (
            <>
              ...
              {!isEditing && (
                <div className="flex items-center gap-2">
                  {managedIdentityOptions.clientId ? (
                    <>
